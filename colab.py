...
from amazed.builder import Builder
from amazed.solver import AStar
...
class GameMaster():
    ...
    def __init__(self, maze_algorithm_class: Builder = DepthFirstSearch, seed = 0, playerA : Player=None, playerB : Player=None):
